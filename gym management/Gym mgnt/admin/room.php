						...
						<form name="form" method="post">
                            <div class="form-group">
                                            ...
                                            <select name="troom"  class="form-control" required>
                                                ...
                                                <option value="Superior Room">FREE</option>
                                                <option value="Deluxe Room">SIX MONTH</option>
												<option value="Guest House">ONE MONTH</option>
												<option value="Single Room"> YEARLY</option>
                                            </select>
                              </div>
								...
								<div class="form-group">
                                            ...
                                            <select name="bed" class="form-control" required>
												<option value selected ></option>
                                                <option value="Single">Weight Gain</option>
                                                <option value="Double">Weight Loss</option>
